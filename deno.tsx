...
// Admin URL: https://your-domain.com/<UUID>
// =========================================================

// 1. Your unique UUID
// const userID = "93f6e6d0-9593-4104-8991-f28bb00d59a0";
const userID = "6ad984d9-cc68-43ab-9ae1-e1d9a7d73e8c";
// 2. Admin Path: Domain + UUID
...
function buildAdminHtml(req: Request) {
    ...
    const rows = renderDashboardRows([
        ...
        { label: "Protocol", value: protocol, escape: false },
        { label: "Transport", value: transport, escape: false },
        { label: "TLS", value: tls, escape: false },
        { label: "Port", value: port, escape: false },
        { label: "Path", value: wsPath },
        { label: "UUID", value: userID },
        { label: "Admin URL", value: origin + dashboardPath },
...
<body>
    <div class="wrap">
        <header>
            ...
            <h1>VLESS Node Admin</h1>
            <p class="desc">View connection parameters and deployment status</p>
        </header>
...
${rows}
        ...
        <section>
            <p class="note">
                Directly accessing the domain displays the camouflage page. Visit <code>/${escapeHtml(userID)}</code> to access the admin panel.<br>
                Client configuration: Host: Domain, Port: <code>443</code>, Transport: <code>ws</code>, Path: <code>/</code>.
            </p>
        </section>
    </div>
